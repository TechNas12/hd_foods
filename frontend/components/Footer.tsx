...
export default function Footer() {
  return (
    <footer className="bg-stone-900 text-white pt-32 pb-16 overflow-hidden">
          ...
          >
            <Link href="/" className="flex items-center gap-3 group">
              <motion.div
                ...
                className="w-16 h-16 shrink-0 aspect-square bg-red-700 rounded-full flex items-center justify-center text-white font-bold text-2xl border-2 border-yellow-500 shadow-lg shadow-red-900/20"
              >
            ...
            <div className="flex gap-4">
              {[Instagram, Facebook, Twitter].map((Icon, i) => (
                <motion.button
                  key={i}
                  whileHover={{ scale: 1.1, backgroundColor: "#B91C1C", borderColor: "#B91C1C" }}
                  whileTap={{ scale: 0.95 }}
            ...
            <ul className="flex flex-col gap-5">
              {[
                ...
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-white/40 hover:text-red-500 transition-colors font-medium flex items-center group gap-0 hover:gap-3"
                  >
                    <span className="w-0 overflow-hidden group-hover:w-4 transition-all opacity-0 group-hover:opacity-100 text-red-700 font-black">›</span>
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          >
            ...
            <ul className="flex flex-col gap-8">
              <li className="flex items-start gap-5 text-white/40 group">
                <div className="p-3 bg-white/5 rounded-2xl group-hover:bg-red-700/10 group-hover:text-red-500 transition-colors shrink-0">
                  <MapPin size={22} />
                </div>
              ...
              <li className="flex gap-5 text-white/40 group">
                <div className="p-3 bg-white/5 rounded-2xl group-hover:bg-red-700/10 group-hover:text-red-500 transition-colors">
              ...
              <li className="flex gap-5 text-white/40 group">
                ...
                <span className="font-medium">hello@hdfoods.com</span>
              </li>
            </ul>
          </motion.div>
